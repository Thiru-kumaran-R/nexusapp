...
export default function industryDetails({ industry, error }) {
    ...
    return (
        ...
        <MainLayout title={industry.organizationName || 'Industry Details'}>
            <div className="container mx-auto px-4 sm:px-8 py-4">
                <Breadcrumb title={industry.organizationName || 'Industry'} />
                <div className="flex flex-col md:flex-row bg-white p-6 rounded-lg shadow-md">
                    <div className="md:w-1/3 lg:w-1/4 mb-4 md:mb-0 flex justify-center">
                        <img
                            src={`https://via.placeholder.com/150?text=${industry.organizationName}`}
                            alt={`${industry.organizationName} Logo`}
                            className="rounded-lg shadow-md"
                        />
                    </div>
                    <div className="md:w-2/3 lg:w-3/4 md:pl-6">
                        <h1 className="text-3xl font-bold mb-4">{industry.organizationName}</h1>
                        <h2 className="text-xl font-semibold">Industry Details</h2>
                        <div className="border-t border-gray-200 mt-2 mb-4"></div>
                        <p className="mb-2"><strong>Name:</strong> {industry.organizationName}</p>
