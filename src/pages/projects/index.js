...
export function DisplayProject({index, project}) {
...
export default function AllProjects() {
    ...
    const isFilterSelected = () => {
        return filter.theme !== "" || filter.domain !== "" || filter.category !== "";
    };
    useEffect(() => {
        ...
        <MainLayout title="All Projects">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
                ...
                <div className="flex space-x-4 mb-4">
                    ...
                    {!isFilterSelected() ? (
                        <div className="columns-1 md:columns-2 lg:columns-3 gap-4 mt-3">
                        <div className="error-message">Please select a filter criteria.</div>
                        </div>
                    ) : (
